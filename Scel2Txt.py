...
def single_file():
    input_path = r'D:\data\scel\167\安徽\安徽.scel'  # 输入scel所在文件夹路径
    output_path = r'D:\data\scel2txt\167\安徽\安徽.txt'  # 输出txt所在文件夹路径
    # 转换scel为txt
...
if __name__ == '__main__':
    ...
    # Scel保存路径
    SavePath = r"D:\data\scel"
    # TXT保存路径
    txtSavePath = r"D:\data\scel2txt"
